...
# python main.py -p 3 -r 2 -P atomic_commit --evaluate --algorithm dqn --model mlp --model_load results/temp/dqn_mlp_3_2.pth > evaluate.log 2>&1

################ train test simple majority
# python -u main.py -p 3 -r 1 -P simple_majority --algorithm a2c --model mlp_op --model_save results/temp/temp.pth --log_level info > temp.log 2>&1
...
# python -u main.py -p 3 -r 3 -P atomic_commit --algorithm a2c --model set_transformer --model_save results/temp/temp.pth --epochs 100 --log_level info > temp.log 2>&1
